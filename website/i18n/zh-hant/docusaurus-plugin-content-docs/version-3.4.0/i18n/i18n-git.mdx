...
一個**可行的翻譯策略**是透過 Git（或任何其他[版本控制系統](https://en.wikipedia.org/wiki/Version_control)）**對翻譯檔案進行版本控制**。
...
保持翻譯檔案與原始檔案**一致可能具有挑戰性**，特別是對於 Markdown 文件。

### Markdown 翻譯 {#markdown-translations}

當未翻譯的 Markdown 文件被編輯時，**維護相應的翻譯檔案是您的責任**，我們目前沒有好的方法來協助您完成此工作。

為了保持翻譯站點的一致性，當 `website/docs/doc1.md` 文檔被編輯時，您需要**將這些編輯反向移植**到 `i18n/fr/docusaurus-plugin-content-docs/current/doc1.md`。
