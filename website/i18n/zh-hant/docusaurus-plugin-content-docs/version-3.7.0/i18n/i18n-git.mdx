...
一個**可行的翻譯策略**是使用 Git（或任何其他[版本控制系統](https://en.wikipedia.org/wiki/Version_control)）**對翻譯檔案進行版本控制**。
...
保持翻譯檔案與原始檔案**一致**可能**具有挑戰性**，尤其是 Markdown 文件。

### Markdown 翻譯 {#markdown-translations}

當未翻譯的 Markdown 文件被編輯時，**您有責任維護相應的翻譯檔案**，但我們目前沒有好的方法來協助您完成此工作。
...
編輯按鈕將改為連結至本地化文件 `i18n/fr/docusaurus-plugin-content-docs/current/doc1.md`。