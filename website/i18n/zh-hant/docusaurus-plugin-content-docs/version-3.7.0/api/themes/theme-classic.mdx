...
有關配置的更多詳情，您可以參考[主題配置頁面](theme-configuration.mdx)。
...
如果您已安裝 `@docusaurus/preset-classic`，則無需將其作為依賴項單獨安裝。
...
主題的大部分配置在 `themeConfig` 中完成，詳見[主題配置](./theme-configuration.mdx)。
