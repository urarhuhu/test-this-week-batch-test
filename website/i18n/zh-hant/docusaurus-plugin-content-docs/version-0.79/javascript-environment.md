...
- 使用 Chrome 偵錯時，所有 JavaScript 程式碼會在 Chrome 瀏覽器內執行，並透過 WebSocket 與原生程式碼通訊。Chrome 使用 [V8](https://v8.dev/) 作為 JavaScript 引擎。
...
React Native 內建 [Babel JavaScript 編譯器](https://babeljs.io)。詳見 [Babel 文件](https://babeljs.io/docs/plugins/#transform-plugins)了解支援的轉換功能。

完整的 React Native 轉換清單可查閱 [@react-native/babel-preset](https://github.com/facebook/react-native/tree/main/packages/react-native-babel-preset)。
...
所有支援的 JavaScript 執行環境皆提供許多標準函式。
