...
:::warning[部分功能僅在生產環境有效]

[訂閱功能](../../blog.mdx#feed) 需透過解析建置輸出實現，因此 **僅在生產環境生效**。
...
Markdown 文件可使用以下 [前置元資料](../../guides/markdown-features/markdown-features-intro.mdx#front-matter) 欄位，需以 `---` 分隔線包覆。
