...
在 Android 上，這僅對 API 版本 23 及以上產生影響。
...
:::warning
由於 Android 15 引入了邊到邊強制執行，在 API 級別 35 中設置狀態列為半透明已被棄用，設置它將不會產生任何效果。您可以在此處閱讀更多關於我們的[邊到邊建議](https://github.com/react-native-community/discussions-and-proposals/discussions/827)。
:::
