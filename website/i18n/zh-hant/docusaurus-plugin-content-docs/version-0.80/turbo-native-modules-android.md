...
最後，我們需要告訴 React Native 主應用程式如何找到這個 `Package`。這稱為在 React Native 中「註冊」套件。

在此情況下，您需將其添加到 [getPackages](https://github.com/facebook/react-native/blob/8d8b8c343e62115a5509e1aed62047053c2f6e39/packages/react-native/ReactAndroid/src/main/java/com/facebook/react/ReactNativeHost.java#L233) 方法的回傳值中。
