...
請參閱 [Docusaurus 國際化 RFC](https://github.com/facebook/docusaurus/issues/3317) 以了解我們研究這些系統的筆記和連結。
...
當未翻譯的 Markdown 文件被編輯時，**您有責任維護相應的翻譯檔案**，不幸的是我們沒有好的方法來幫助您完成此工作。
