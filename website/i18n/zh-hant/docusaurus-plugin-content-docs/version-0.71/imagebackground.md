...
在某些情況下，您可能不想使用 `<ImageBackground>`，因為其實作較為基礎。如需更深入瞭解，請參考 `<ImageBackground>` 的[原始碼](https://github.com/facebook/react-native/blob/0.71-stable/Libraries/Image/ImageBackground.js)，並在需要時建立自訂元件。
