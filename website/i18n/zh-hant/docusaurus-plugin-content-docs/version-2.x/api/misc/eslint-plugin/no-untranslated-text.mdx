...
強制要求 JSX 中的文字標籤必須使用翻譯函式包裝

當使用[國際化功能](../../../i18n/i18n-introduction.mdx)時，此規則確保網站上顯示的所有標籤都可翻譯，避免任何字串意外漏譯。
...
若未使用[國際化功能](../../../i18n/i18n-introduction.mdx)，可停用此規則。對於不應翻譯的文字也可停用此規則。
