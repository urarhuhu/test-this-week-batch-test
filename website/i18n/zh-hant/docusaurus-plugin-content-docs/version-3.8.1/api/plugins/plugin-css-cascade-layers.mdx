...
此插件用於將 Docusaurus 網站的 CSS 模組封裝於 [CSS 層疊層級](https://css-tricks.com/css-cascade-layers/)中。此現代 CSS 功能已獲所有主流瀏覽器廣泛支援，可將 CSS 規則分組至特定層級，賦予您對 CSS 層疊更精確的控制權。
...
為正確使用此插件，建議您充分理解 [CSS 層疊層級](https://css-tricks.com/css-cascade-layers/)、[CSS 層疊機制](https://developer.mozilla.org/docs/Web/CSS/CSS_cascade/Cascade)及[優先級計算](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_cascade/Specificity)。
