...
當網站初始化完成後，專案原始碼將包含可透過套件管理工具執行的 Docusaurus 腳本：
...
請注意部分功能（例如錨點連結）在開發模式下無法運作，正式環境中將正常運作。

:::

:::info[網路開發模式]

當從遠端伺服器或虛擬機（如 GitHub Codespaces）轉發 3000 埠時，可指定 `0.0.0.0` 參數使開發伺服器監聽本地 IP：
