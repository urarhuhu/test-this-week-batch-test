...
> **已棄用。** 請改用其中一個[社群套件](https://reactnative.directory/?search=clipboard)。
...
當你嘗試複製任何非 `string` 和 `number` 的資料到剪貼簿時要小心，某些資料需要額外的字串化處理。例如，如果你嘗試複製陣列 - Android 會引發異常，但 iOS 則不會。