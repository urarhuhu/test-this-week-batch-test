...
用於將 [Google Tag Manager (gtm.js)](https://developers.google.com/tag-platform/tag-manager) 添加到 Docusaurus 網站的插件。可搭配標準的 [gtag 插件](./plugin-google-gtag.mdx) 使用，深入分析用戶如何使用您的網站。
