...
Docusaurus 預設的頁面插件。經典模板預設配置了此插件。該插件提供[建立頁面](guides/creating-pages.mdx)功能。
...
Markdown 頁面可使用以下 Markdown [前置元資料](../../guides/markdown-features/markdown-features-intro.mdx#front-matter)欄位，需以 `---` 分隔線包圍。
