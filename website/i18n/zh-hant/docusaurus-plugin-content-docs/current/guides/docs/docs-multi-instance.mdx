...
有時您會希望一個 Docusaurus 站點能托管兩套（或更多）獨立的文檔集。

這些文檔集甚至可能具有不同的版本化/發布週期。
...
當有人編輯 iOS 文檔時，重新構建整個未變更的 Android 文檔是否真的有必要？

:::

### 版本化與非版本化文檔 {#versioned-and-unversioned-doc}

有時您會希望部分文檔進行版本控制，而其他「全局性」文檔則無需版本化。

我們在 Docusaurus 官網就採用此模式：
