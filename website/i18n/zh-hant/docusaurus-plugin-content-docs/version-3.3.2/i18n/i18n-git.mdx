...
- **維護困難**：您必須保持翻譯檔案與未翻譯檔案**同步**

:::note

部分**大型技術專案**（如 React、Vue.js、MDN、TypeScript、Nuxt.js 等）使用 Git 進行翻譯。

詳見 [Docusaurus 國際化 RFC](https://github.com/facebook/docusaurus/issues/3317) 以了解我們研究這些系統的筆記與連結。

:::

## 初始化 {#initialization}

以下將逐步說明如何使用 Git 將新初始化的英文 Docusaurus 網站翻譯為法文，並假設您已遵循[國際化教學](./i18n-tutorial.mdx)。
...
保持翻譯檔案與原始檔案**一致可能具有挑戰性**，尤其是 Markdown 文件。
