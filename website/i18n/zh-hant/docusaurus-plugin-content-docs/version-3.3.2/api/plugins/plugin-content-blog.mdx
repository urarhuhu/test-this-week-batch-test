...
[訂閱功能](../../blog.mdx#feed) 會擷取建置輸出結果，因此 **僅在正式環境中生效**。
...
Markdown 文件可使用下列 Markdown [前置資料](../../guides/markdown-features/markdown-features-intro.mdx#front-matter) 中繼資料欄位，需以 `---` 分隔線包覆。
