...
強制要求 JSX 中的文字標籤必須使用 translate 呼叫進行包裹。

當使用 [i18n 功能](../../../i18n/i18n-introduction.mdx) 時，此規則確保網站上顯示的所有標籤都是可翻譯的，避免任何字串意外未經翻譯而顯示。
...
如果您未使用 [i18n 功能](../../../i18n/i18n-introduction.mdx)，可以停用此規則。在文字不需要翻譯的情況下，也可以停用此規則。
