...
在 [#7490](https://github.com/facebook/docusaurus/pull/7490) 中，我們新增了對 Mermaid 圖表的支援。這填補了 GitHub Flavored Markdown 近期也[新增支援](https://github.blog/2022-02-14-include-diagrams-markdown-files-mermaid/)的功能缺口。您可以使用 Markdown 代碼區塊來建立 Mermaid 圖表：
...
- [#8192](https://github.com/facebook/docusaurus/pull/8192) 和 [#8159](https://github.com/facebook/docusaurus/pull/8159): 更嚴格驗證 `siteConfig.url` 並提供更清晰的錯誤訊息
- [#8066](https://github.com/facebook/docusaurus/pull/8066): 使設定檔中的 `url` 和 `baseUrl` 更具容錯性，減少對前導或結尾斜線的敏感性
...
完成主題翻譯是一項[持續進行的工作](https://github.com/facebook/docusaurus/issues/3526)，也是為 Docusaurus 做出貢獻的簡單方式。我們會定期新增主題功能，通常需要[新的翻譯](https://github.com/facebook/docusaurus/issues/3526)。
...
- [#8059](https://github.com/facebook/docusaurus/pull/8059): 版本/語言導航欄下拉選單在導航時保留錨點和查詢字串
- [#8227](https://github.com/facebook/docusaurus/pull/8227): 客戶端重定向插件在重定向時保留錨點和查詢字串
